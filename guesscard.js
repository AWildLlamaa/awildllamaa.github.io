...
async function askQuestion(question) {
  try {
    const prompt = `Given a Magic the Gathering card named "${cardData.name}" with a color identity of "${cardData.color_identity}" and type "${cardData.type_line}", ${question}?`;
